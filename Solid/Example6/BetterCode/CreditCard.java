...
public abstract class CreditCard {
    ...
    //This Abstarct class is now Contain only which support all the credit card types and not any other payment method like UPI, Net Banking etc. So we are following the Interface Segregation Principle here. 
